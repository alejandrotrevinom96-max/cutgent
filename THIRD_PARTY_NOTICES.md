...
Claudit incluye o depende de componentes de terceros, cada uno bajo su propia
licencia. Esta lista es informativa (no exhaustiva); las licencias completas
viven en `node_modules/<paquete>/LICENSE`.

| Componente | Uso en Claudit | Licencia | Nota |
|---|---|---|---|
...
> Nota legal pendiente (decisión del propietario): si Claudit se distribuye
